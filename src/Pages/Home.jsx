        ...
        <div className="container mt-5 py-5 text-center">
          ...
          <div className="row text-center g-4">
            <div className="col-md-3 col-6">
             <i className="fa-solid fa-truck fa-2xl" style={{color:" #cb0606"}}></i>
              <p className="mt-2">Express Delivery</p>
               <p className="mt-2" style={{color:"grey"}}>Ships in 24 Hours </p>
            </div>

            <div className="col-md-3 col-6">
           <i className="fa-solid fa-shield fa-2xl"  style={{color:" #cb0606"}}></i>
              <p className="mt-2">Brand Warranty</p>
               <p className="mt-2" style={{color:"grey"}}>100% orginal products </p>
            </div>

            <div className="col-md-3 col-6">
             <i className="fa-solid fa-tag fa-2xl" style={{color:" #cb0606"}}></i>
              <p className="mt-2 ">Exciting Deals </p>
              <p className="mt-2" style={{color:"grey"}}>On all prepaid orders </p>
            </div>

            <div className="col-md-3 col-6">
              <i className="fa-solid fa-credit-card fa-2xl" style={{color:" #cb0606"}}></i>
              <p className="mt-2">Secure Payments</p>
               <p className="mt-2"style={{color:"grey"}}>SSL/Secure certificate</p>
            </div>
          </div>
        </div>
      </div>
